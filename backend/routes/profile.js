...
async function getProfile(req, res) {
    try {
        ...
        const [userRows] = await db.pool.query(userSql, [userId]);
        ...
        const [activeBidCount] = await db.pool.query(
...
async function updateProfile(req, res) {
    try {
        ...
        await db.pool.query(updateSql, updateParams);
...
async function getMyAuctions(req, res) {
    try {
        ...
        const [auctions] = await db.pool.query(sql, params);
...
async function getMyBids(req, res) {
    try {
        ...
        const [bidRecords] = await db.pool.query(sql, [userId]);
