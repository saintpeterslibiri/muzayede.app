...
async function getAllAuctions(req, res) {
    try {
        ...
        // db.pool.query() returns array: [rows, fields]
...
async function getAuctionById(req, res) {
    try {
        ...
        const [rows] = await db.pool.query(sql, [auctionId]);
...
async function createAuction(req, res) {
    try {
        ...
        const [newAuction] = await db.pool.query(
...
async function deleteAuction(req, res) {
    try {
        ...
        const [bidRows] = await db.pool.query(
