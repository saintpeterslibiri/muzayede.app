            ...
            <div class="auction-main">
                ...
                <div class="auction-info">
                    ...
                    <div class="auction-stats">
                        ...
                        <?php if (isset($auction['user_auto_bid']) && $auction['user_auto_bid']['is_active']): ?>
                            <div class="stat-row" style="background-color: #f0f8ff; padding: 8px; border-radius: 4px; margin-top: 8px;">
                                <span class="stat-label">My Auto-Bid</span>
                                <span class="stat-value" style="color: #0066cc; font-weight: bold;">$<?php echo htmlspecialchars(number_format((float)$auction['user_auto_bid']['max_amount'], 2)); ?></span>
                            </div>
                        <?php endif; ?>
